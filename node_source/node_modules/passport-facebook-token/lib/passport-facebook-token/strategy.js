...
FacebookTokenStrategy.prototype.authenticate = function(req, options) {
  ...
  self._loadUserProfile(accessToken, function(err, profile) {
    if (err) {console.log(JSON.stringify("err: "+err)); return self.fail(err); };
    
    function verified(err, user, info) {
      if (err) { console.log(JSON.stringify("err: "+err)); return self.error(err); }
      if (!user) {console.log(JSON.stringify("info: "+info)); return self.fail(info); }
        console.log(JSON.stringify("user success: "+user));
